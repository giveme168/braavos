...
class OutSourceTarget(db.Model, BaseModelMixin):
    __tablename__ = 'searchAd_out_source_target'
...
table_merger_outsources = db.Table('searchAd_merget_outsources',
                                   db.Column(
                                       'mergeroutsource_id', db.Integer, db.ForeignKey('searchAd_merger_out_source.id')),
                                   db.Column(
                                       'outsource_id', db.Integer, db.ForeignKey('searchAd_out_source.id'))
                                   )


class OutSource(db.Model, BaseModelMixin, CommentMixin):
    __tablename__ = 'searchAd_out_source'
    id = db.Column(db.Integer, primary_key=True)
...
table_merger_douban_outsources = db.Table('searchAd_merget_douban_outsources',
                                          db.Column(
                                              'mergerdoubanoutsource_id', db.Integer,
                                              db.ForeignKey('searchAd_merger_douban_out_source.id')),
                                          db.Column(
                                              'doubanoutsource_id', db.Integer,
                                              db.ForeignKey('searchAd_douban_out_source.id'))
                                          )


class OutSourceExecutiveReport(db.Model, BaseModelMixin):
    __tablename__ = 'searchAd_bra_outsource_executive_report'
    id = db.Column(db.Integer, primary_key=True)
    target_id = db.Column(db.Integer, db.ForeignKey('out_source_target.id'))
...
class DoubanOutSource(db.Model, BaseModelMixin, CommentMixin):
    __tablename__ = 'searchAd_douban_out_source'
    id = db.Column(db.Integer, primary_key=True)
    target_id = db.Column(db.Integer, db.ForeignKey('out_source_target.id'))
    target = db.relationship('OutSourceTarget', backref=db.backref(
...
class MergerOutSource(db.Model, BaseModelMixin, CommentMixin):
    __tablename__ = 'searchAd_merger_out_source'
...
class MergerDoubanOutSource(db.Model, BaseModelMixin, CommentMixin):
    __tablename__ = 'searchAd_merger_douban_out_source'
