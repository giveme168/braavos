...
direct_sales = db.Table('searchAd_framework_order_direct_sales',
                        db.Column(
                            'sale_id', db.Integer, db.ForeignKey('user.id')),
                        db.Column(
                            'client_order_id', db.Integer, db.ForeignKey('searchAd_bra_framework_order.id'))
                        )
agent_sales = db.Table('searchAd_framework_order_agent_sales',
                       db.Column(
...
agents = db.Table('searchAd_framework_order_agents',
                  db.Column('agent_id', db.Integer, db.ForeignKey('searchAd_agent.id')),
                  db.Column(
                      'framework_order_id', db.Integer, db.ForeignKey('searchAd_bra_framework_order.id')),
                  )


class FrameworkOrder(db.Model, BaseModelMixin, CommentMixin, AttachmentMixin):
    __tablename__ = 'searchAd_bra_framework_order'
