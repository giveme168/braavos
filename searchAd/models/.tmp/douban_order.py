...
direct_sales = db.Table('searchAd_douban_order_direct_sales',
                        db.Column(
                            'direct_sale_id', db.Integer, db.ForeignKey('user.id')),
                        db.Column(
                            'douban_order_id', db.Integer, db.ForeignKey('bra_douban_order.id'))
                        )
agent_sales = db.Table('searchAd_douban_order_agent_sales',
                       db.Column(
...
operater_users = db.Table('searchAd_douban_order_users_operater',
                          db.Column(
                              'user_id', db.Integer, db.ForeignKey('user.id')),
                          db.Column(
                              'order_id', db.Integer, db.ForeignKey('bra_douban_order.id'))
                          )
designer_users = db.Table('searchAd_douban_order_users_designerer',
                          db.Column(
                              'user_id', db.Integer, db.ForeignKey('user.id')),
                          db.Column(
                              'order_id', db.Integer, db.ForeignKey('bra_douban_order.id'))
                          )
planer_users = db.Table('searchAd_douban_order_users_planer',
                        db.Column(
                            'user_id', db.Integer, db.ForeignKey('user.id')),
                        db.Column(
                            'order_id', db.Integer, db.ForeignKey('bra_douban_order.id'))
...
class DoubanOrder(db.Model, BaseModelMixin, CommentMixin, AttachmentMixin):
    __tablename__ = 'searchAd_bra_douban_order'
...
class DoubanOrderExecutiveReport(db.Model, BaseModelMixin):
    __tablename__ = 'searchAd_bra_douban_order_executive_report'
    id = db.Column(db.Integer, primary_key=True)
...
class DoubanOrderReject(db.Model, BaseModelMixin):
    __tablename__ = 'searchAd_bra_douban_order_reject'
    id = db.Column(db.Integer, primary_key=True)
    douban_order_id = db.Column(
        db.Integer, db.ForeignKey('bra_douban_order.id'))  # 客户合同
    douban_order = db.relationship(
