...
from searchAd.models.invoice import (searchAdAgentInvoice, INVOICE_TYPE_CN, AGENT_INVOICE_BOOL_INVOICE_CN,
...
searchAd_saler_client_order_agent_invoice_bp = Blueprint(
    'searchAd_saler_client_order_agent_invoice', __name__, template_folder='../../../../templates')


@searchAd_saler_client_order_agent_invoice_bp.route('/<order_id>/order', methods=['GET'])
def index(order_id):
...
@searchAd_saler_client_order_agent_invoice_bp.route('/<order_id>/order/new', methods=['POST'])
...
@searchAd_saler_client_order_agent_invoice_bp.route('/<invoice_id>/invoice', methods=['POST', 'GET'])
...
@searchAd_saler_client_order_agent_invoice_bp.route('/<invoice_id>/invoice/pay/new', methods=['POST'])
...
@searchAd_saler_client_order_agent_invoice_bp.route('/<invoice_id>/invoice/pay/<invoice_pay_id>/update', methods=['POST'])
...
@searchAd_saler_client_order_agent_invoice_bp.route('/<invoice_id>/update', methods=['POST'])
def update_invoice(invoice_id, redirect_endpoint='searchAd_saler_client_order_agent_invoice.index'):
    invoice = searchAdAgentInvoice.get(invoice_id)
    if not invoice:
        abort(404)
    form = AgentInvoiceForm(request.form)
...
@searchAd_saler_client_order_agent_invoice_bp.route('/<invoice_id>/apply_pay', methods=['POST'])
...
@searchAd_saler_client_order_agent_invoice_bp.route('/<invoice_id>/apply', methods=['POST'])
...
@searchAd_saler_client_order_agent_invoice_bp.route('/<agent_id>/tax_info', methods=['POST'])
