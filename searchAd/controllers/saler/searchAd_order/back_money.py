...
from searchAd.models.client_order import searchAdClientOrder, searchAdBackMoney, searchAdBackInvoiceRebate
...
@searchAd_saler_client_order_back_money_bp.route('/order/<order_id>/back_money/<bid>/delete', methods=['GET'])
...
@searchAd_saler_client_order_back_money_bp.route('/order/<order_id>/back_money/<bid>/delete_invoice', methods=['GET'])
