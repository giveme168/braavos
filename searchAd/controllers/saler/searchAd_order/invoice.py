...
from searchAd.models.invoice import (searchAdInvoice, INVOICE_STATUS_CN, INVOICE_TYPE_CN,
...
searchAd_saler_client_order_invoice_bp = Blueprint(
    'searchAd_saler_client_order_invoice', __name__, template_folder='../../../../templates/saler')


@searchAd_saler_client_order_invoice_bp.route('/<order_id>/order', methods=['GET'])
def index(order_id):
...
@searchAd_saler_client_order_invoice_bp.route('/<order_id>/order/new', methods=['POST'])
...
@searchAd_saler_client_order_invoice_bp.route('/<invoice_id>/apply', methods=['POST'])
