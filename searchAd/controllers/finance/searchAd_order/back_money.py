...
from searchAd.models.client_order import searchAdClientOrder, searchAdBackMoney, searchAdBackInvoiceRebate, CONTRACT_STATUS_CN

searchAd_finance_client_order_back_money_bp = Blueprint(
    'searchAd_finance_client_order_back_money', __name__, template_folder='../../../../templates/finance/client_order')


ORDER_PAGE_NUM = 50


@searchAd_finance_client_order_back_money_bp.route('/orders', methods=['GET'])
def index():
...
@searchAd_finance_client_order_back_money_bp.route('/order/<order_id>/back_money', methods=['GET', 'POST'])
...
@searchAd_finance_client_order_back_money_bp.route('/order/<order_id>/back_invoice', methods=['GET', 'POST'])
...
@searchAd_finance_client_order_back_money_bp.route('/order/<order_id>/back_money/<bid>/delete', methods=['GET'])
...
@searchAd_finance_client_order_back_money_bp.route('/order/<order_id>/back_money/<bid>/delete_invoice', methods=['GET'])
