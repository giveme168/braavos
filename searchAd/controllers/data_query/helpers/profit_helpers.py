...
def write_order_excel(orders, year, month):
    ...
    keys = [u'所属区域', u'合同号', u'客户名称', u'直客/代理', u'项目名称', u'合同总金额',
            u'已回款金额', u'客户' + str(month) + u'月执行额',
            u'投放媒体', u'媒体合同号', u'媒体合同下单金额',
            str(month) + u'月下单金额',
            str(month) + u'月媒体执行金额',
            str(month) + u'月合同利润',
            u'合同开始', u'合同结束']
    ...
    for k in range(len(orders)):
        ...
        if len(mediums) > 1:
            ...
            for i in range(len(mediums)):
                ...
                worksheet.write(
                    th, 10, mediums[i].medium_money2 or '', align_left)
            ...
            if orders[k].medium_orders:
                ...
                worksheet.write(
                    th, 10, orders[k].medium_orders[0].medium_money2 or '', align_left)
