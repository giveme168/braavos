...
searchAd_data_query_accrued_bp = Blueprint(
    'searchAd_data_query_accrued', __name__,
    template_folder='../../templates/searchAd/data_query')
...
@searchAd_data_query_accrued_bp.route('/search_client_order', methods=['GET'])
