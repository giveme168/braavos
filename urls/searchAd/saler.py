...
from searchAd.controllers.saler.searchAd_order.bill_invoice import searchAd_saler_client_order_bill_invoice_bp
...
def searchAd_saler_register_blueprint(app):
    ...
    app.register_blueprint(searchAd_saler_client_order_bill_invoice_bp, url_prefix='/saler/searchAd_orders/bill_invoice')
