...
from searchAd.controllers.finance.searchAd_order.bill_invoice import searchAd_finance_bill_invoice_bp
...
def searchAd_finance_register_blueprint(app):
    ...
    app.register_blueprint(searchAd_finance_bill_invoice_bp, url_prefix='/finance/searchAd_order/bill_invoice')
