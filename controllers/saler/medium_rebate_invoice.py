...
saler_medium_rebate_invoice_bp = Blueprint(
    'saler_medium_rebate_invoice', __name__, template_folder='../../templates/saler')


@saler_medium_rebate_invoice_bp.route('/<order_id>/order', methods=['GET'])
def index(order_id):
    ...
    return tpl('/saler/medium_rebate_invoice/index.html', order=client_order,
...
def update_invoice(invoice_id):
    ...
    return redirect(url_for("saler_medium_rebate_invoice.index", order_id=invoice.client_order.id))


@saler_medium_rebate_invoice_bp.route('/<invoice_id>/apply', methods=['POST'])
