...
@saler_medium_invoice_bp.route('/<invoice_id>/invoice/pay/new', methods=['POST'])
def new_invoice_pay(invoice_id):
    ...
    if mi.pay_invoice_money + money > mi.money:
        ...
        return redirect(url_for('saler_medium_invoice.invoice', invoice_id=invoice_id))
...
@saler_medium_invoice_bp.route('/<invoice_id>/invoice/pay/<invoice_pay_id>/update', methods=['POST'])
