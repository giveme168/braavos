...
saler_client_order_invoice_bp = Blueprint(
    'saler_client_order_invoice', __name__, template_folder='../../templates/saler')


@saler_client_order_invoice_bp.route('/<order_id>/order', methods=['GET'])
def index(order_id):
...
@saler_client_order_invoice_bp.route('/<order_id>/order/new', methods=['POST'])
...
@saler_client_order_invoice_bp.route('/<invoice_id>/update', methods=['POST'])
...
@saler_client_order_invoice_bp.route('/<invoice_id>/apply', methods=['POST'])
