...
saler_client_order_data_query_bp = Blueprint(
    'saler_client_order_data_query', __name__, template_folder='../../templates/saler/data_query')


@saler_client_order_data_query_bp.route('/agent_invoice', methods=['GET'])
def agent_invoice():
...
@saler_client_order_data_query_bp.route('/back_money', methods=['GET'])
def back_money():
    now_date = datetime.datetime.now()
    info = request.values.get('info', '').strip()
    location = int(request.values.get('location', 0))
...
@saler_client_order_data_query_bp.route('/back_invoice', methods=['GET'])
def back_invoice():
    now_date = datetime.datetime.now()
    info = request.values.get('info', '').strip()
    location = int(request.values.get('location', 0))
...
@saler_client_order_data_query_bp.route('/rebate_agent_invoice', methods=['GET'])
...
@saler_client_order_data_query_bp.route('/pay_rebate_agent_invoice', methods=['GET'])
...
@saler_client_order_data_query_bp.route('/medium_invoice', methods=['GET'])
def medium_invoice():
    now_date = datetime.datetime.now()
    info = request.values.get('info', '').strip()
    location = int(request.values.get('location', 0))
...
@saler_client_order_data_query_bp.route('/pay_medium_invoice', methods=['GET'])
...
@saler_client_order_data_query_bp.route('/medium_rebate_invoice', methods=['GET'])
...
@saler_client_order_data_query_bp.route('/personal_outsource', methods=['GET'])
...
@saler_client_order_data_query_bp.route('/outsource', methods=['GET'])
def outsource():
    now_date = datetime.datetime.now()
    info = request.values.get('info', '').strip()
    location = int(request.values.get('location', 0))
