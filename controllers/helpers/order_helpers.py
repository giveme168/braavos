            ...
            if len(mediums) > 1:
                if not g.user.is_media_leader():
                    ...
                    for i in range(len(mediums)):
                        worksheet.write(
                            th, 19, mediums[i].media.name, align_left)
                        worksheet.write(
                ...
                if orders[k].medium_orders:
                    worksheet.write(
                        th, 19, orders[k].medium_orders[0].media.name, align_left)
                    worksheet.write(
                        th, 20, orders[k].medium_orders[0].finish_status_cn, align_left)
                    worksheet.write(
                        th, 21, orders[k].medium_orders[0].medium_contract, align_left)
                    worksheet.write(
                        th, 22, orders[k].medium_orders[0].sale_money, align_left)
                    worksheet.write(
                        th, 23, orders[k].medium_orders[0].medium_money2, align_left)
                    worksheet.write(
                        th, 24, '', align_left)
                    worksheet.write(
                        th, 25, '', align_left)
                    worksheet.write(
                        th, 26, orders[k].medium_orders[0].sale_CPM, align_left)
                    worksheet.write(
                        th, 27, orders[k].medium_orders[0].medium_CPM, align_left)
                    worksheet.write(
                        th, 28, orders[k].medium_orders[0].start_date_cn, align_left)
                    worksheet.write(
                        th, 29, orders[k].medium_orders[0].end_date_cn, align_left)
                    worksheet.write(
                        th, 30, orders[k].medium_orders[0].operater_names, align_left)
                if orders[k].associated_douban_orders:
                    worksheet.write(
                        th, 31, orders[k].associated_douban_orders[0].name, align_left)
                    worksheet.write(
                        th, 32, orders[k].associated_douban_orders[0].contract, align_left)
                    worksheet.write(
                        th, 33, orders[k].associated_douban_orders[0].campaign, align_left)
                    worksheet.write(
                        th, 34, orders[k].associated_douban_orders[0].money, align_left)
                else:
                    worksheet.write(th, 31, '', align_left)
                    worksheet.write(th, 32, '', align_left)
                    worksheet.write(th, 33, '', align_left)
