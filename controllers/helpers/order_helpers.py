...
def write_client_excel(orders):
    ...
    keys = [u'代理/直客(甲方全称)', u'客户合同号', u'客户名称', u'Campaign名称', u'客户合同金额(元)',
            ...
            u'售卖类型', u'代理/直客', u'投放媒体', u'媒体订单状态', u'媒体合同号', u'售卖金额(元)', u'媒体金额(元)',
        ...
        if orders[k].contract and orders[k].back_money_status != -1:
            ...
            if len(mediums) > 1:
                ...
                for i in range(len(mediums)):
                    ...
                    worksheet.write(th, 24, mediums[i].sale_CPM, align_left)
                    worksheet.write(th, 25, mediums[i].medium_CPM, align_left)
                    worksheet.write(th, 26, mediums[i].start_date_cn, align_left)
                    worksheet.write(th, 27, mediums[i].end_date_cn, align_left)
                    worksheet.write(th, 28, mediums[i].operater_names, align_left)
                    if mediums[i].associated_douban_order:
                        worksheet.write(
                            th, 29, mediums[i].associated_douban_order.name, align_left)
                        worksheet.write(
                            th, 30, mediums[i].associated_douban_order.contract, align_left)
                        worksheet.write(
                            th, 31, mediums[i].associated_douban_order.campaign, align_left)
                        worksheet.write(
                            th, 32, mediums[i].associated_douban_order.money, align_left)
                    else:
                ...
                if orders[k].medium_orders:
                    ...
                    worksheet.write(
                        th, 23, '', align_left)
                    worksheet.write(
                        th, 24, orders[k].medium_orders[0].sale_CPM, align_left)
                    worksheet.write(
                        th, 25, orders[k].medium_orders[0].medium_CPM, align_left)
                    worksheet.write(
                        th, 26, orders[k].medium_orders[0].start_date_cn, align_left)
                    worksheet.write(
                        th, 27, orders[k].medium_orders[0].end_date_cn, align_left)
                    worksheet.write(
                        th, 28, orders[k].medium_orders[0].operater_names, align_left)
                if orders[k].associated_douban_orders:
                    worksheet.write(
                        th, 29, orders[k].associated_douban_orders[0].name, align_left)
                    worksheet.write(
                        th, 30, orders[k].associated_douban_orders[0].contract, align_left)
                    worksheet.write(
                        th, 31, orders[k].associated_douban_orders[0].campaign, align_left)
                    worksheet.write(
                        th, 32, orders[k].associated_douban_orders[0].money, align_left)
                else:
                    worksheet.write(th, 29, '', align_left)
                    worksheet.write(th, 30, '', align_left)
                    worksheet.write(th, 31, '', align_left)
