...
def info(order_id):
    ...
    return tpl('/finance/agent_pay/info.html', order=order, invoices=invoices)
...
def pay_info(invoice_id):
    ...
    return tpl('/finance/agent_pay/pay_info.html', invoice=invoice, reminder_emails=reminder_emails,
