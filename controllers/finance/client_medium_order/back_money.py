...
from models.client_medium_order import ClientMediumOrder, BackMoney, BackInvoiceRebate, CONTRACT_STATUS_CN
from libs.email_signals import back_money_apply_signal

finance_client_medium_order_back_money_bp = Blueprint(
    'finance_client_medium_order_back_money', __name__, template_folder='../../templates/finance/client_medium_order')


ORDER_PAGE_NUM = 50


@finance_client_medium_order_back_money_bp.route('/orders', methods=['GET'])
def index():
...
@finance_client_medium_order_back_money_bp.route('/order/<order_id>/back_money', methods=['GET', 'POST'])
...
@finance_client_medium_order_back_money_bp.route('/order/<order_id>/back_invoice', methods=['GET', 'POST'])
...
@finance_client_medium_order_back_money_bp.route('/order/<order_id>/back_money/<bid>/delete', methods=['GET'])
...
@finance_client_medium_order_back_money_bp.route('/order/<order_id>/back_money/<bid>/delete_invoice', methods=['GET'])
