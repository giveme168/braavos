...
finance_douban_order_back_money_bp = Blueprint(
    'finance_douban_order_back_money', __name__, template_folder='../../templates/finance/douban_order')


ORDER_PAGE_NUM = 50


@finance_douban_order_back_money_bp.route('/orders', methods=['GET'])
def index():
...
@finance_douban_order_back_money_bp.route('/order/<order_id>/back_money', methods=['GET', 'POST'])
def back_money(order_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for("finance_douban_order_back_money.back_money", order_id=order.id))
    return tpl('/finance/douban_order/back_money/info.html', order=order)


@finance_douban_order_back_money_bp.route('/order/<order_id>/back_invoice', methods=['GET', 'POST'])
...
@finance_douban_order_back_money_bp.route('/order/<order_id>/back_money/<bid>/delete', methods=['GET'])
...
@finance_douban_order_back_money_bp.route('/order/<order_id>/back_money/<bid>/delete_invoice', methods=['GET'])
